    ...
    public function __invoke(): View
    {
        $fases = [
            ...
            [
                ...
                'andamento' => 75,
                'esforco_restante' => 4,
                'notas' => 'Campos `finalizada/finalizada_em/finalizada_por` + botao Finalizar + complementar() exige justificativa (min 10), anexada a observacao. FURO: VistoriaPolicy::update checa owner ANTES de finalizada, entao o DONO ainda edita vistoria finalizada (corrigir ordem das clausulas). Complementacao sem historico estruturado (vai p/ texto livre em observacao).',
            ],
            [
                'codigo' => '1.9',
            ...
            [
                ...
                'andamento' => 50,
                'esforco_restante' => 1,
                'notas' => 'Mascara "00:00" aplicada em vistorias/show e report.blade (label "Data/Hora"->"Data"). PENDENTE em index.blade (e minhas-vistorias, que reusa index) e em report-print.blade — ainda imprimem 00:00. Replicar o padrao $temHora nesses 2 pontos. (98% sao legados pre-2026 sem hora.)',
            ],
            [
                'codigo' => '1.11',
