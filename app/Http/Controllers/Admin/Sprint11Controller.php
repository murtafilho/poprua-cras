    ...
    public function __invoke(): View
    {
        $fases = [
            ...
            [
                ...
                'andamento' => 100,
                'esforco_restante' => 0,
                'notas' => 'Inputs `camera-input-back` (capture) e `gallery-input` + legendas_fotos validadas em Store E UpdateVistoriaRequest. CORRIGIDO: update() agora persiste a legenda das fotos novas (withCustomProperties), alinhado ao store(). Endpoint PATCH .../legenda para edicao avulsa.',
            ],
            [
                'codigo' => '1.5',
            ...
            [
                ...
                'andamento' => 100,
                'esforco_restante' => 0,
                'notas' => '`houve_lavratura` + `tipo_protocolo` (chuva/frio/normal) + agora `houve_lavacao` (limpeza com agua) como campo distinto: migration add_houve_lavacao_to_vistorias, fillable/cast no Model, validacao em Store/Update, switch em create/edit e exibicao em show. Lavratura (auto formal) != lavacao.',
            ],
            [
                'codigo' => '1.10',
