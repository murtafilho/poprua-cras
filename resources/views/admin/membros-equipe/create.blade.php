...
@section('header')
    <div class="mobile-header-content">
        ...
        <span class="mobile-header-title">Cadastrar Membro</span>
...
@section('content')
    <div class="page-content">
        <div class="card">
            <div class="card-body">
                <h2 class="form-section-title">Novo Membro da Equipe</h2>

                <form action="{{ route('admin.membros-equipe.store') }}" method="POST">
