                ...
                <div class="tab-content hidden" data-tab="2">
                        ...
                        <div class="card-body">
                            ...
                            <div class="segmented" role="radiogroup">
                                <label class="seg-option">
                                    <input type="radio" name="conducao_forcas_seguranca" value="1" x-on:change="toggleConducaoObs()">
                                    <span>Sim</span>
                                </label>
                                <label class="seg-option">
                                    <input type="radio" name="conducao_forcas_seguranca" value="0" checked x-on:change="toggleConducaoObs()">
                                    <span>Não</span>
                                </label>
                            </div>
                    ...
                    <div class="card mb-3">
                        <div class="card-body">
                            ...
                            <div class="segmented" role="radiogroup">
                                <label class="seg-option">
                                    <input type="radio" name="apreensao_fiscal" value="1" x-on:change="document.getElementById('qtd_kg_container').classList.toggle('hidden', $event.target.value !== '1')">
                                    <span>Sim</span>
                                </label>
                                <label class="seg-option">
                                    <input type="radio" name="apreensao_fiscal" value="0" checked x-on:change="document.getElementById('qtd_kg_container').classList.toggle('hidden', $event.target.value !== '1')">
                                    <span>Não</span>
                                </label>
                            </div>
                    ...
                    <div class="card mb-3">
                        <div class="card-body">
                            ...
                            <div class="segmented" role="radiogroup">
                                <label class="seg-option">
                                    <input type="radio" name="auto_fiscalizacao_aplicado" value="1" x-on:change="toggleAutoNumero()">
                                    <span>Sim</span>
                                </label>
                                <label class="seg-option">
                                    <input type="radio" name="auto_fiscalizacao_aplicado" value="0" checked x-on:change="toggleAutoNumero()">
                                    <span>Não</span>
                                </label>
                            </div>
                    ...
                    <div class="card mb-3">
                        <div class="card-body">
                            ...
                            <div class="segmented" role="radiogroup">
                                <label class="seg-option">
                                    <input type="radio" name="houve_lavratura" value="1" x-on:change="toggleProtocolo()">
                                    <span>Sim</span>
                                </label>
                                <label class="seg-option">
                                    <input type="radio" name="houve_lavratura" value="0" checked x-on:change="toggleProtocolo()">
                                    <span>Não</span>
                                </label>
                            </div>
                    ...
                    <div class="card mb-3">
                        <div class="card-body">
                            ...
                            <div class="segmented" role="radiogroup">
                                <label class="seg-option">
                                    <input type="radio" name="houve_comunicado" value="1" x-on:change="toggleComunicado()">
                                    <span>Sim</span>
                                </label>
                                <label class="seg-option">
                                    <input type="radio" name="houve_comunicado" value="0" checked x-on:change="toggleComunicado()">
                                    <span>Não</span>
                                </label>
                            </div>
